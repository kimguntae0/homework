# Generated by Django 4.2 on 2024-12-24 02:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ImageField(blank=True, null=True, upload_to=products.models.product_image_path)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('views', models.PositiveIntegerField(default=0)),
                ('HashTag', models.ManyToManyField(blank=True, related_name='products', to='products.hashtag')),
